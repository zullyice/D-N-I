...
public class formBanHangChinh extends javax.swing.JPanel {
    ...
    public void loadSanPham(List<SanPham> list) {
        model = (DefaultTableModel) tblSanPham.getModel();
        model.setRowCount(0);
        for (SanPham sp : list) {
            model.addRow(new Object[]{sp.getId_SPCT(), sp.getTenSanPham(), sp.getSoluongtonkho(), sp.getGia(), sp.getTenThuongHieu(), sp.getTenNSX(), sp.getTenChatLieu(), sp.getTenKichThuoc(), sp.getTenKhoa(), sp.getKieuDang(), sp.getTenMauSac()});
    ...
    public void huyHoaDon(int idHoaDon) {
        ...
        try (Connection con = DBConnect.getConnection()) {
            ...
            try (PreparedStatement psHDCT = con.prepareStatement(sqlDeleteHoaDonCT); PreparedStatement psHD = con.prepareStatement(sqlDeleteHoaDon)) {
                sanPhamService.traLaiSanPham(idHoaDon, con);
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(cboTenNV, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(124, 124, 124))
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/com/icon/synchronize_2749336.png"))); // NOI18N
    ...
    private void btnXoaHoaDonChoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaHoaDonChoActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                List<SanPham> sanPhamList = sanPhamService.layDanhSachSanPhamCuaHoaDon(id);
                sanPhamService.capNhatSoLuongTonKho(sanPhamList);
                huyHoaDon(id);
                loadSanPham();
                loadHDCTTable(id);
                clearFiel();
    ...
    private void txtTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTimKiemActionPerformed
        ...
        List<SanPham> timKiem = sanPhamService.getAllSPBHTimKiem(ten);
        loadSanPham(timKiem);
